...
export class FavoritesView extends Favorites {
    constructor(root) {
        ...
        this.tdbody = this.root.querySelector('table tbody');
        this.update();
        this.onadd();
    }
    ...
    update() {
        ...
        this.entries.forEach(user => {
            ...
            row.querySelector('.user a').href = `https://github.com/Julio-Cassiano`;
    ...
    removeAllTr() {
        this.tdbody.querySelectorAll('tr').forEach(tr => {
            tr.remove()
        });
